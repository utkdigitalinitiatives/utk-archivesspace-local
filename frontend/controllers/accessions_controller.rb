class AccessionsController < ApplicationController
  ...
  def index
    respond_to do |format| 
      format.html {   
        @search_data = Search.for_type(session[:repo_id], "accession", params_for_backend_search.merge({"facet[]" => SearchResultData.ACCESSION_FACETS, "fl" => "id,uri,four_part_id,title,identifier,accession_date,finding_aid_status,fullrecord"}))
      }
      format.csv { 
        search_params = params_for_backend_search.merge({"facet[]" => SearchResultData.ACCESSION_FACETS, "fl" => "id,uri,four_part_id,title,identifier,accession_date,finding_aid_status,fullrecord"})
